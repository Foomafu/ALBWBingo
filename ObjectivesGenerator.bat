...
:input
echo How many goals would you like to generate? (1-41):
set /p number=

REM Validate input is a number between 1 and 41
if "%number%"=="" goto invalid
for /l %%i in (1,1,41) do if "%number%"=="%%i" goto valid
